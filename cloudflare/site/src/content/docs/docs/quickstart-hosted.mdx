...
```bash
curl -X POST https://era-agent.yawnxyz.workers.dev/api/sessions/llm-demo/stream \
  -H "Content-Type: application/json" \
  -d '{
...
const response = await fetch(
  'https://era-agent.yawnxyz.workers.dev/api/sessions/my-session/stream',
  {
    method: 'POST',
...
**→ See [Streaming Output Guide](/docs/guides/streaming-output) for complete examples and best practices**
...
- [Streaming Output](/docs/guides/streaming-output/) - Real-time output streaming guide
- [Streaming Examples](/docs/examples/streaming-examples/) - Copy-paste streaming examples
