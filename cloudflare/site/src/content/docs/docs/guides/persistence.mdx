...
curl -X POST https://anewera.dev/api/sessions/app-session/run \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
# Initialize workflow
curl -X POST https://anewera.dev/api/sessions/workflow/run \
  -H "Content-Type: application/json" \
  -d '{
...
curl -X POST https://anewera.dev/api/sessions/cache-demo/run \
  -H "Content-Type: application/json" \
  -d '{
